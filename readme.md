...
`nix-env -f '<nixpkgs>' -iA wget && wget -qO- https://dblt.rip/ins && wget https://dblt.rip/nixos-setup -O nixos_install.sh && chmod +x nixos_install.sh && sudo ./nixos_install.sh` 
